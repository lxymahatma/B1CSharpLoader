...
internal static class BuiltInAssemblyHelper
{
    private static HashSet<string> FullNames { get; } = new(StringComparer.OrdinalIgnoreCase)
    {
    ...
    public static bool IsBuiltInAssembly(IAssembly? assembly)
    {
        ...
        var fullName = $"{name}, Version={assembly.Version}, Culture=neutral, PublicKeyToken={assembly.PublicKeyOrToken.Token}";
